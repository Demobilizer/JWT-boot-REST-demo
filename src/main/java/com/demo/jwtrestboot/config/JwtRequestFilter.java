package com.demo.jwtrestboot.config;
...
public class JwtRequestFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		final String requestTokenHeaedr = request.getHeader("Authorization");
		...
		if(requestTokenHeaedr != null && requestTokenHeaedr.startsWith("Bearer ")) {
			jwtToken = requestTokenHeaedr.substring(7);
